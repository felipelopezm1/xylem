...
const SOCIETY = ogPage({
  ...
  description:
    'A provocation on trade, Voltaire, chagra, and biomimicry proxies — how nature intelligence meets economic coordination.',
...
export default function middleware(request) {
  ...
  if (BOTS.test(ua) && request.nextUrl.pathname === '/xylem-of-society') {
