...
.zones{position:fixed;left:0;right:0;top:clamp(56px,7.5vw,72px);bottom:clamp(48px,6.5vw,64px);z-index:20;display:flex;pointer-events:none}
.zones #zPrev,.zones #zNext{flex:0 0 min(16vw,200px);cursor:pointer;pointer-events:auto}
.zones .zPass{flex:1;pointer-events:none}
...
<div class="zones"><span id="zPrev"></span><span class="zPass" aria-hidden="true"></span><span id="zNext"></span></div>
...
SLIDES = """
  ...
  <section class="slide" data-sec="Let's build">
    ...
    <div class="inner stack"><span class="eyebrow g step" data-i18n="s16.eye">Let's collaborate</span>
      ...
      <p class="lead step" style="max-width:46ch" data-i18n="s16.lead">An open invitation to bring biomimicry and agentic AI into critical economics \u2014 showcasing at <b>Circus London</b> and <b>EHU Bilbao</b> for JEC26.</p>
